...
// import { useTranslation } from "react-i18next"; // لم نعد نحتاجها
...
const HostRequestsTable: React.FC = () => {
  ...
  const [selectedRequest, setSelectedRequest] = useState<HostRequest | null>(
    null
  );
  // لم نعد نحتاج للترجمة في هذا المكون
  ...
  const getRequestTypeLabel = (type: string) => {
    if (type === "personal") {
      return "شخصي";
    } else if (type === "business" || type === "business_or_office") {
      return "عمل أو مكتب";
    }
    return "غير محدد";
  };
          ...
          <div className="flex items-center">
            ...
            <div className="mr-3">
              <p className="text-sm text-blue-800">
                <strong>ملاحظة:</strong> يمكنك الموافقة أو رفض الطلبات المعلقة
                فقط.
              </p>
            </div>
          </div>
