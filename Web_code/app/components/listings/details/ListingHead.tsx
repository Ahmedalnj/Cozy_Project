...
import HeartButton from "@/app/components/features/HeartButton";
      ...
      <div className="flex items-start justify-between">
        <Heading
          ...
          subtitle={
            showLabel && location
              ? `${
                  i18n.language === "ar" ? location.region : location.regionEn
                }, ${
                  i18n.language === "ar" ? location.label : location.labelEn
                }`
              : ""
          }
        />
