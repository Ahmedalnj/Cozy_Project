const PloicyContent = () => (
  <div className="space-y-4 text-sm text-neutral-700 leading-relaxed max-h-[70vh] overflow-y-auto pr-2">
    ...
    <p>
      ...
      with the help of the [Free Privacy Policy
    ...
    <p>
      ...
      of directors or other managing authority. * Company (referred to as either
      "the Company", "We", "Us" or "Our" in this Agreement) refers to cozy. *
      ...
      history on that website among its many uses. * Country refers to: Libya *
      ...
      create an account to use the Service. * Usage Data refers to data
      ...
      page visit). * Website refers to cozy, accessible from http://www.cozy.com
      * You means the individual accessing or using the Service, or the company,
      or other legal entity on behalf of which such individual is accessing or
      using the Service, as applicable.
    </p>
    <hr />
    <h3 className="font-semibold">Collecting and Using Your Personal Data</h3>
    <br />
    ...
    <p>
      ...
      Facebook * Instagram * Twitter * LinkedIn If You decide to register
      ...
      with the Company through Your Third-Party Social Media Service's account.
    ...
    <p>
      ...
      and analyze Our Service. The technologies We use may include: * Cookies or
      Browser Cookies. A cookie is a small file placed on Your Device. You can
      ...
      to use some parts of our Service. Unless you have adjusted Your browser
      ...
      about cookies on the [Free Privacy Policy
      website](https://www.freeprivacypolicy.com/blog/sample-privacy-policy-
      template/#Use_Of_Cookies_And_Tracking) article. We use both Session and
      ...
      users and prevent fraudulent use of user accounts. Without these Cookies,
      the services that You have asked for cannot be provided, and We only use
      ...
      on the Website. * Functionality Cookies Type: Persistent Cookies
    ...
    <p>
      ...
      * To manage Your Account: to manage Your registration as a user of the
      ...
      about unless You have opted not to receive such information. * To manage
      Your requests: To attend and manage Your requests to Us. * For business
    ...
    <p>
      ...
      Service. You may update, amend, or delete Your information at any time by
      signing in to Your Account, if you have one, and visiting the account
      settings section that allows you to manage Your personal information. You
      may also contact Us to request access to, correct, or delete any personal
      information that You have provided to Us. Please note, however, that We
      may need to retain certain information when we have a legal obligation or
    ...
    <hr />
    <h3 className="font-semibold text-2xl">Law enforcement</h3>
    <p>
