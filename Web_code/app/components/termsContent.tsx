const TermsContent = () => (
  <div className="space-y-4 text-sm text-neutral-700 leading-relaxed max-h-[70vh] overflow-y-auto pr-2">
    <p>
    ...
    <h3 className="font-semibold text-2xl">Interpretation and Definitions</h3>
    <hr />
    ...
    <p>
      ...
      directors or other managing authority. * Country refers to: Libya *
      Company (referred to as either "the Company", "We", "Us" or "Our" in this
      Agreement) refers to cozy. * Device means any device that can access the
      ...
      Conditions agreement has been created with the help of the [Free Terms and
      Conditions
      ...
      Service. * Website refers to cozy, accessible from http://cozy.com * You
    ...
    <p>
      ...
      access or use the Service. By accessing or using the Service You agree to
      ...
      is also conditioned on Your acceptance of and compliance with the Privacy
    ...
    <hr />
    <h3 className="font-semibold">Links to Other Websites </h3>
    <p>
    ...
    <hr />
    <h3 className="font-semibold">"AS IS" and "AS AVAILABLE" Disclaimer </h3>
    <p>
    ...
    <hr />
    <h3 className="font-semibold">Disputes Resolution</h3>
    <p>
    ...
    <hr />
    <h3 className="font-semibold">For European Union (EU) Users</h3>
    <p>
      If You are a European Union consumer, you will benefit from any mandatory
      provisions of the law of the country in which You are resident.
    </p>
    <hr />
    <h3 className="font-semibold">United States Legal Compliance </h3>
    <p>
    ...
    <hr />
    <br />
    <h3 className="font-semibold text-2xl">Severability and Waiver </h3>
    ...
    <hr />
    <h3 className="font-semibold">Translation Interpretation</h3>
    <p>
    ...
    <hr />
    <h3 className="font-semibold">Changes to These Terms and Conditions </h3>
    <p>
    ...
    By Email:<p className="font-bold">ahmed.alnjjar40@gmail.com</p>
    By Phone Number: <p className="font-bold">0918692144</p>
  </div>
);
